export const mockFilmsResponse = {
	...
	results: [
		...
		{
			title: 'Mock The Empire Strikes Back',
			episode_id: 5,
			opening_crawl:
		...
		{
			title: 'Mock Attack of the Clones',
			episode_id: 2,
			opening_crawl:
		...
		{
			title: 'Mock Revenge of the Sith',
			episode_id: 3,
			opening_crawl:
